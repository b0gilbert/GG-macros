...
//	"Load PELICAN Package"
	SubMenu "PELICAN"
		...
		"Neighbor Angles/F"
		"Neighbor Angles with Mask/G"
		// "Calculate Neighbor Angles/G"
		"Kill Histograms"
	End
	SubMenu "Polarization"
		"Display Polarization Panel"
		"Display Stack Operation Panel"
		"Image Stitching"
		"Align Stack"
	End
//	"Unload PELICAN Package"
End
...
Function Pelican()
	...
	String defPath 	= S_path + "User Procedures:PELICAN"
	NewPath /O PELIDefaultsPath defPath
...
Function MakePELICANVariables()
	...
	// ClearPol means Delete prior Polarization calculations. 
	// Intended when doing calculations on a subset of the image. 
